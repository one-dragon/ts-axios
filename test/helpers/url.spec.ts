...
describe('helpers: url', () => {
  describe('buildURL', () => {
    ...
    test('should use serializer if provided', () => {
      ...
      expect(serializer).toHaveBeenCalled() // 函数被调用过
      expect(serializer).toHaveBeenCalledWith(params) // 调用时使用的参数
    })
  ...
  describe('isAbsoluteURL', () => {
    test('should return true if URL begins with vaild scheme name', () => {
